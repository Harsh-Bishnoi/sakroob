                ...
                <div className="max-w-[1140px] mx-auto px-3">
                    <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="w-full lg:w-8/12">
                            ...
                            <div className="flex flex-col md:flex-row gap-[30px] mt-[26px]">
                                {["First name", "Last name"].map((label, index) => (
                                    <div
                                        key={index}
                                        className="flex-col flex bg-[#F4F8F7] py-[13px] px-[26px] rounded-xl w-full"
                                    >
                                        <label className="text-xs leading-[150%] text-[#8393A0]">
                                            {label} (Optional)
                                        </label>
                            ...
                            <div className="flex justify-between items-center bg-[#F4F8F7] py-[13px] px-[26px] rounded-xl w-full mt-[20px]">
                                ...
                                />
                                <p className="font-semibold leading-[150%] text-[#112D49] whitespace-nowrap ml-4">
                                    AED 20.00
                                </p>
                            </div>
                            ...
                            <div className="border border-[#E8EBED] py-[20px] px-[28px] mt-[20px]">
                                ...
                                <div className="flex justify-between flex-wrap">
                                    <div className="flex gap-[8px] items-center">
                                        <label className="inline-flex items-center cursor-pointer">
                                            ...
                                            />
                                            <div
                                                className={`w-6 h-6 rounded-full flex items-center justify-center transition-all duration-200 ${selected === "paypal"
                                ...
                                <div className="flex gap-[8px] items-center pt-[34px]">
                                    <label className="inline-flex items-center cursor-pointer">
                                        ...
                                        />
                                        <div
                                            className={`w-6 h-6 rounded-full flex items-center justify-center transition-all duration-200 ${selected === "card"
                                                ? "border-4 border-blue-400"
                                                : "border-2 border-gray-300"
                                                }`}
                                        >
                                ...
                                <div className="flex items-center gap-[8px] mt-[48px]">
                                    <label className="inline-flex items-center cursor-pointer">
                                        ...
                                        />
                                        <div
                                            className={`w-6 h-6 rounded-full flex items-center justify-center transition-all duration-200 ${selected === "bank"
                                                ? "border-4 border-blue-400"
                                                : "border-2 border-gray-300"
                                                }`}
                                        >
                        ...
                        <div className="w-full lg:w-4/12 relative overflow-visible mt-10 lg:mt-0">
                            <div
                                className={`absolute top-[-50px] right-0 bg-green-100 border border-green-400 text-green-700 px-4 py-2 rounded-md shadow-md text-sm z-10 transition-transform duration-500 ease-out ${couponApplied
                            ...
                            <div className="p-3.5 shadow-lg rounded-[8px]">
                                ...
                                <div className="flex flex-col sm:flex-row justify-between gap-[10px] mt-[10px]">
                                    ...
                                    />
                                    <CustomButton onClick={handleApplyCoupon} btnClass="font-medium text-[#112D49] border border-[#112D49] max-w-[119px] w-full whitespace-nowrap py-2 px-[15px] rounded-[93px] hover:bg-[#112D49]/80 hover:text-white transition-all ease-linear duration-200" btnText="Apply Now" />
                                </div>
                                <CustomButton btnClass="hover:bg-[#112D49]/80 hover:text-white !w-full !max-w-[330px] mt-5" btnText="Buy Now" />
                            </div>
                        </div>
                    </div>
                </div>
